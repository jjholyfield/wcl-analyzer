...
// CLI args: node tmp-generic-audit.mjs <playerName> <className> <specName>
...
if (!PLAYER || !CLASS || !SPEC) {
  console.log('Usage: node tmp-generic-audit.mjs <playerName> <className> <specName>');
  process.exit(1);
}
...
async function main() {
  ...
  for (const fight of fights) {
    ...
    const healthstone = castOnly.filter(e => {
    ...
    pullData.push({
      ...
      spellCounts, dpsPot, healthstone, healthPot, earlyDeath,
    });
